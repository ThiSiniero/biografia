...
const Apresentation = () => {
    return (
        <div id='home' style={{ backgroundImage: `url(${fundoHome})` }} className="bg-cover min-h-screen flex flex-col justify-center items-center text-center px-4 pt-28 md:pt-6">
            ...
            <div className="md:max-w-[80%] w-full p-8 rounded-lg shadow-lg md:mt-20 ">
                ...
                <p className="text-md md:text-xl font-white text-white">
