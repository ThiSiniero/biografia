...
const Competences = () => {
    ...
    return (
        <section className="competences bg-gray-100 pb-20">
            ...
            <div className="general-skills mb-10">
                ...
                <div className="competences-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 px-4 w-[95%] mx-auto">
                    {generalSkills.map((skill) => (
                        <div
                            key={skill.name}
                            className="competence-item flex flex-col items-center bg-white shadow-md rounded-lg p-4 hover:shadow-lg transition-shadow"
                        >
                            <img
                                src={skill.logo}
                                alt={`${skill.name} logo`}
                                className="competence-logo w-16 h-16 mb-4"
                            />
